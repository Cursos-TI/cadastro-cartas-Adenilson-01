...
int main() {
    ...
    int populacao1; float area1; double pib1; int pontosTuristicos1; 
    float densidadePopulacional1; double pibPerCapita1;              
    double superPoder1;                                              

    // Variáveis para a Carta 2
    char estado2; char codigo2[10]; char nomeCidade2[50];
    int populacao2; float area2; double pib2; int pontosTuristicos2; 
    float densidadePopulacional2; double pibPerCapita2;              
    double superPoder2;                                              
    ...
    // O Super Poder é a soma de todos os atributos.
    superPoder1 = (double)populacao1 + (double)area1 + (pib1 * 1000000000.0) + (double)pontosTuristicos1 + (double)pibPerCapita1 + (1.0 / (double)densidadePopulacional1);

    // Cálculos da Carta 2
    densidadePopulacional2 = (float)populacao2 / area2;
    pibPerCapita2 = (pib2 * 1000000000.0) / (double)populacao2;
    superPoder2 = (double)populacao2 + (double)area2 + (pib2 * 1000000000.0) + (double)pontosTuristicos2 + (double)pibPerCapita2 + (1.0 / (double)densidadePopulacional2);
